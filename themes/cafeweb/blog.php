    ...
    <?php if (empty($blog) && !empty($search)): ?>
        ...
        <div class="content content">
            <div class="empty_content">
                ...
                <p class="empty_content_desc">Você pesquisou por <?= $search ?? "<b>TESTE</b>"; ?>. Tente outros termos</p>
                <a class="empty_content_btn gradient gradient-green gradient-hover radius" href="<?= url("/blog"); ?>"
                    title="Blog">... ou volte ao Blog</a>
            </div>
        </div>
